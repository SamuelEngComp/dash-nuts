...
public class BancaService {
	...
	public BigDecimal somandoValores(BancaExaminadora banca) {
		...
		case 4:
			valorTotalDiarias = banca.getDiarias()
					.add(banca.getDiarias02().add(banca.getDiarias03().add(banca.getDiarias04())));
			valorTotalIda = banca.getValorIda()
					.add(banca.getValorIda02().add(banca.getValorIda03().add(banca.getValorIda04())));
			valorTotalVolta = banca.getValorVolta()
					.add(banca.getValorVolta02().add(banca.getValorVolta03().add(banca.getValorVolta04())));
			totalEconomizado = valorTotalDiarias.add(valorTotalIda).add(valorTotalVolta);
			break;

		case 5:
			valorTotalDiarias = banca.getDiarias().add(
					banca.getDiarias02().add(banca.getDiarias03().add(banca.getDiarias04().add(banca.getDiarias05()))));
			valorTotalIda = banca.getValorIda().add(banca.getValorIda02()
					.add(banca.getValorIda03().add(banca.getValorIda04().add(banca.getValorIda05()))));
			valorTotalVolta = banca.getValorVolta().add(banca.getValorVolta02()
					.add(banca.getValorVolta03().add(banca.getValorVolta04().add(banca.getValorVolta05()))));
			totalEconomizado = valorTotalDiarias.add(valorTotalIda).add(valorTotalVolta);
			break;
